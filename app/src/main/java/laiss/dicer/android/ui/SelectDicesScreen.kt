...
import laiss.dicer.android.ui.theme.Subtext0
import laiss.dicer.android.ui.viewModels.Result
import laiss.dicer.android.ui.viewModels.Results
import laiss.dicer.android.ui.viewModels.SelectDicesViewModel
        ...
        Column {
            TabRow(selectedTabIndex = state.activeTabIndex) {
                state.layoutStates.forEachIndexed { index, _ ->
                    Tab(text = { Text(text = "Option $index") },
...
fun ResultDialogPreview() {
    ...
    DicerTheme {
        ResultDialog(
            onDismissRequest = {}, results = exampleResults, modifier = Modifier.padding(3.dp)
        )
    }
}
    ...
    Dialog(onDismissRequest = onDismissRequest) {
        LazyColumn(
            ...
            items(results.layoutResults) {
                ElevatedCard {
                    Column(
                        modifier = Modifier.padding(7.dp), horizontalAlignment = Alignment.Start
                    ) {
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            Text(text = "${"Expectation"}:", fontSize = 15.sp, color = Subtext0)
                            Spacer(modifier = Modifier.width(10.dp))
                            Text(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            Text(text = "${"Deviation"}:", fontSize = 15.sp, color = Subtext0)
                            Spacer(modifier = Modifier.width(10.dp))
                            Text(
                        ...
                        Spacer(modifier = Modifier.height(10.dp))
                        Text(text = it.checkDescription, fontSize = 15.sp, color = Subtext0)
                    }
                }
            }
        }
